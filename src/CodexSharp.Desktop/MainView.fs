...
module MainView =
    ...
    let applyWindowTheme () = DesktopChrome.applyWindowTheme ()
    ...
    let private jsBool (el: JsonElement) (name: string) = DesktopChrome.jsBool el name
    ...
    let private diffViews (diff: string) : IView list = DesktopChrome.diffViews diff
    let private jsStr (el: JsonElement) (name: string) = DesktopChrome.jsStr el name
    ...
    let private toActivityRows () = DesktopChrome.toActivityRows ()
    ...
    let create () =
        Component(fun ctx ->
            ...
            let writeConfig (key: string) (value: string) = DesktopChrome.writeConfig session state modelDraft key value
            let toggleFeature (name: string) (enabled: bool) = DesktopChrome.toggleFeature session state modelDraft name enabled
